...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.student.setMaximumSize(QtCore.QSize(284, 265))
        font = QtGui.QFont()
        font.setFamily("微软雅黑")
        ...
        self.gridLayout.addWidget(self.student, 0, 0, 3, 2, QtCore.Qt.AlignVCenter)
        ...
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.klass3.sizePolicy().hasHeightForWidth())
        self.klass3.setSizePolicy(sizePolicy)
        font = QtGui.QFont()
        font.setFamily("微软雅黑")
        font.setPointSize(12)
        ...
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.klass2.sizePolicy().hasHeightForWidth())
        self.klass2.setSizePolicy(sizePolicy)
        font = QtGui.QFont()
        font.setFamily("微软雅黑")
        font.setPointSize(12)
